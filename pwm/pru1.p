// PRUSS program to output a simple PWM signal at fixed sample rate of 1000
// Written by amc6630 on 3/11/2018
// Output is r30.5: P9.27
...
SETUP:
  ...
  CLR r30.t5             // Set output to low when in IDLE mode
